...
"И сегодня у тебя есть шанс проверить свои знания и логику.\n" +
"А самым находчивым мы подарим памятные призы!\n" +
"После прохождения всех заданий обязательно подходи к стенду Netcracker за своим выигрышем.\n" +
"Обращаем внимание, что приятные подарочки получат самые быстрые из вас!";
    public static final String GOODBYE_MESSAGE_TOP = "Обменять полученные баллы на призы можно у стенда Netcracker уже сейчас.\n\n" + 
"А для самых амбициозных у нас есть супер-предложение! Уже сейчас у тебя есть возможность начать карьеру в сфере IT.\n" + 
"Подавай заявку до 27 июня на бесплатное обучение в нашем Учебном Центре: http://msk.edu-netcracker.com &#128521;";
